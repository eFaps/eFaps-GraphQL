...
public final class CIGraphQL
{
    ...
    public static final _InputFieldDefinition InputFieldDefinition = new _InputFieldDefinition(
                    "67d4e1f0-7132-4af3-be5d-1db5a4ea4802");

    public static class _InputFieldDefinition
        extends _FieldDefinitionAbstract
    {
